...
<div className="flex justify-center flex-col items-center h-full w-full">
  ...
  <CardHeader className='text-center '>
    <div className="flex justify-end items-center pt-4 h-1 cursor-pointer"><GrFormClose color="red"
    onClick={closeLogin}
    /></div>
    <div className="flex justify-center ">
<img src={logo} className="w-[60px] rounded mix-blend-color-dodge"></img>
    </div>
    
    <CardTitle className='text-white'>Welcome Back</CardTitle>
    <CardDescription className='text-gray-400 text-[11px]'>Please enters your details to login  </CardDescription>
  ...
  <CardContent>
    <div className="flex flex-col gap-3">
        ...
        <div>
            ...
            ">Email Adress</label>
  <Input className='h-5 border border-dashed border-gray-500
            ...
            <div>
                ...
                <label className="text-zinc-300 text-[13px]">Email Password</label>
  <Input className='h-5 border-dashed border-gray-500 text-[10px] text-zinc-300
  ...
  <Button className='bg-green-600 w-full h-7 text-white'>Login</Button>
...
<span className="block h-px bg-gray-400 w-full"></span>
    ...
    <div className="flex   justify-between mt-2 ">
        <div className="bg-gray-500 rounded gap-1  w-23 flex justify-center items-center">
            <FaGoogle size={20} color="red"/>
              <span className="text-white text-[10px]">with Google</span>
        </div>
    ...
    <div className="flex items-center  gap-1 mt-7">
        <p className="text-zinc-200 text-[12px]">Don't have an account?</p>
        <Link className="text-blue-400 text-[14px]">Register</Link>
    </div>
